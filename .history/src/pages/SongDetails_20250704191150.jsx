...
const SongDetails = () => {
    ...
    const { data: songDetailsData, isFetching: isFetchinRelatedSongs, error } = useGetSongRelatedQuery({ songid });
  ...
  return (
    <div className="flex flex-col">
        ...
        <RelatedSongs
          data={relatedSongsData?.tracks || relatedSongsData }  // Audius related tracks may be nested in `tracks`
          artistId={artistId}
          isPlaying={isPlaying}
