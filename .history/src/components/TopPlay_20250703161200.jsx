        ...
        >
          {topPlays?.slice(0, 5).map((artist,i) => (
            ...
            >
              ...
              <img src={
                artist?.user?.profile_picture?.['150x150']  &&  artist?.user?.profile_picture?.['150x150'] !== "null" ? artist?.user?.profile_picture?.['150x150']  : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKIqW4XT2Ke21VZEqswYz_fm6bff9jSZXUyg&s"
