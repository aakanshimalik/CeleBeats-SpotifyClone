      ...
      <div className='md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#191624] '>
        <div>
         ...
         <div className='flex flex-row gap-0'>
          <h2 className='text-white font-bold text-2xl font-spotify-mix ml-12' style={{color:"red"}}>Cele</h2> 
          <h2 className='text-white font-bold text-2xl font-spotify-mix ml-12' style={{color:"#90EE90"}}>Beats</h2> 
        </div>
        </div>
          <NavLinks />
      </div>
