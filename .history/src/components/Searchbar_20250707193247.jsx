  ...
  return (
    <div className="flex justify-between items-center px-4 py-2">
      ...
      <div className="relative ml-6 mr-6">
        ...
        {showProfile && (
          <div className="absolute right-0 mt-2 w-78 bg-transparent border border-gray-700 text-white rounded-lg shadow-lg p-4 z-50 ">
            <div className="flex flex-col items-center">
              <img
                src={avatar}
                alt="Profile"
                className="w-30 h-30 rounded-full mb-5"
              />
