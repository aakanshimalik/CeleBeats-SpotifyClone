  ...
  return (
    <div className="flex justify-between items-center px-4 py-2">
      ...
      <form
        onSubmit={handleSubmit}
        autoComplete="off"
        className="flex items-center bg-none rounded-full px-2 text-gray-400 focus-within:text-gray-600 w-full max-w-md"
      >
      ...
      <div className="relative ml-4">
        <div
          className="flex items-center gap-2 cursor-pointer p-1 hover:bg-gray-700 rounded-xlg"
        ...
        {showProfile && (
          <div className="absolute right-0 mt-2 w-48 bg-gray-800 text-white rounded-lg shadow-lg p-4 z-50">
            <div className="flex flex-col items-center">
              ...
              />
              <p className="font-semibold">Aakanshi</p>
              <p className="text-sm text-gray-400">aakanshi@example.com</p>
            </div>
          </div>
        )}
      </div>
