...
import { FiSearch } from 'react-icons/fi';
import { MdKeyboardArrowDown } from 'react-icons/md';
import avatar from '../assets/avatar.jpg'; // make sure this path is correct
  ...
  return (
    <div className="flex justify-between items-center px-4 py-2">
      ...
      <form
        onSubmit={handleSubmit}
        autoComplete="off"
        className="flex items-center bg-[#2c2c2c] rounded-full px-2 text-gray-400 focus-within:text-gray-600 w-full max-w-md"
      >
