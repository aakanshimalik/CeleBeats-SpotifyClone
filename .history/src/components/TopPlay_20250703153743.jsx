...
const TopPlay = () => {
  ...
  const topPlays = data?. data?.slice(0, 5);
    ...
    const imageUrl = artist?.user?.profile_picture?.['150 x 150'];
    const validImage = imageUrl && imageUrl.startsWith('http')? imageUrl: '/default-profile.png';
        ...
        >
          {topPlays?.slice(0, 5).map((artist) => (
            ...
            >
              ...
              <img src={
                artist.user?.profile_picture?.['150 x 150']?/startsWith('http')?artist.user?.profile_picture?.['150 x 150'] : '/defauly-profile.png'
