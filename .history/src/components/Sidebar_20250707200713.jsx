      ...
      <div className='md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#191624] '>
        <div>
          <div className='flex flex-row items-center gap-3 mt-4 ml-4'>
            <img src={logo2} alt='logo2' className=' w-14 h-14 object-cover rounded-full ' /> 
            <span className='text-gray-300 font-bold'>X</span>
            <img src={logo1} alt='logo1' className=' w-12 h-12 object-cover rounded-full bg-transparent rounded ' /> 
          </div>
