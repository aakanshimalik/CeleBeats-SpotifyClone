        ...
        {showProfile && (
          <div className="absolute right-0 mt-2 w-58 bg-blue-900 border border-gray-700 text-white rounded-lg shadow-lg p-4 z-50 ">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-300 ml-1">aakanshimalik54@gmail.com</p>
              <p className="text-xs text-gray-200 font-semibold">React Developer Intern <br></br>       <span>(Celebal Summer Internship 2025)</span></p>
            </div>
          </div>
        )}
      </div>
