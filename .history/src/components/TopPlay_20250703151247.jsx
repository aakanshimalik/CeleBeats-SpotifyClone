      ...
      <div ref={divRef} className='xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col'>
        ...
        >
          {topPlays?.slice(0, 5).map((artist) => (
            ...
            >
              <Link to={`/artists/${track.user.id}`}>
              <img src={
                track.user?.profile_picture?.['480 X 480']  ||  artist?.profile_picture?.['150 X 150'] || '/default-profile.png'
                
                } alt={track.user.name} className="rounded-full w-full object-cover" />
                  </Link>
