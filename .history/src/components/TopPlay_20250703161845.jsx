...
import {default-profile} from "../assets/default-profile.jpeg";
        ...
        >
          {topPlays?.slice(0, 5).map((artist,i) => (
            ...
            >
              ...
              <img src={
                artist?.user?.profile_picture?.['150x150']  &&  artist?.user?.profile_picture?.['150x150'] !== "null" ? artist?.user?.profile_picture?.['150x150']  : "../assets/default-profile.jpeg"
