    ...
    <div className="flex flex-col w-[250px] p-4 bg-white/5 bg-opacity-80 backdrop-blur-sm animate-slideup rounded-lg cursor-pointer">
      ...
      <div className="mt-4 flex flex-col">
        ...
        <button
          ...
          className="mt-2 px-3 py-2 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-green-600 hover:opacity-90 rounded-md transition-colors duration-200"
        >
          + Add to Playlist
        </button>
      </div>
