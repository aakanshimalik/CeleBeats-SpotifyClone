      ...
      <div className='md:flex hidden flex-col w-[240px] py-10 px-4 bg-[#191624] '>
        <div>
          <div className='flex flex-row items-center gap-2'>
            <img src={logo2} alt='logo2' className=' w-40 h-20 object-contain ' /> 
            <span className='text-white'>X</span><br></br>
            <img src={logo1} alt='logo1' className=' w-40 h-20 object-contain bg-transparent rounded ' /> 
          </div>
